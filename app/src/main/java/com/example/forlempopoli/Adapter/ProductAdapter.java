...
import com.example.forlempopoli.Activity.ProductImageActivity;
...
import com.example.forlempopoli.diffUtil.ProductDiffUtil;
...
//                }
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView image;
        TextView productName, tvArticleNo, tvMeters, tvPrice, tvofferPrice, update_quantity_dialog, tvSavingPrice;
...
//                    System.out.println("customer_type" + customer_type);
                    if (customer_type.equals("0")) {
                        ...
                        int sellingprice = mproductRequest.getArtSellingPriceAmt();
                        double totalPrice = 0;
                        double cgstAmount = 0;
                        double sgstAmount = 0;

                        Log.d("offerPrice", String.valueOf(offerPrice));
                        if (offerPrice != 0.00) {
...
//                    Log.d("artPhoto", String.valueOf(artPhoto.size()));
                ...
                case R.id.tvviewArtImage:
                    ...
                    String url = productRequestList.get(getAdapterPosition()).getArtPhoto();
                    //if (!url.contains("no-photo.jpg"))
