...
import com.fashion.forlempopoli.Activity.NotificationPanelActivity;
...
import com.fashion.forlempopoli.Fragment.Change_Password_Fragment;
import com.fashion.forlempopoli.Fragment.CustomerLedgerFragment;
import com.fashion.forlempopoli.Fragment.HomeFragment;
import com.fashion.forlempopoli.Fragment.InvoiceFragment;
import com.fashion.forlempopoli.Fragment.OrderStatusFragment;
import com.fashion.forlempopoli.Fragment.PaymentDetailsFragment;
import com.fashion.forlempopoli.Fragment.ProfileViewPagerFragment;
import com.fashion.forlempopoli.Fragment.SaleReturnFragment;
import com.fashion.forlempopoli.Fragment.SamplingDataFragment;
...
import com.fashion.forlempopoli.Utilities.Converter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.search_action:
                mintent = new Intent(MainActivity.this, SearchProductActivity.class);
                ...
                if (response.code() == 200 && response.message().equals("OK")) {
                    ...
                    if (response.body().getStatusCode() == 1 && response.body().getStatusMessage().equals("Success")) {
                        ...
                        if (!list.isEmpty()) {
                            ...
                            System.out.println("getAccDetails" + list.toString());
                            ...
                            mappSharedPreference.putStringValue(Constants.INTENT_KEYS.KEY_VOUCHER_AMT,
                                    String.valueOf(list.get(0).getVoucher_amt()));
