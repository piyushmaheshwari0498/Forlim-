...
import com.fashion.forlempopoli.Adapter.SubCategoryAdapter;
import com.fashion.forlempopoli.Db.connection.DatabaseHelper;
import com.fashion.forlempopoli.Entity.request.SubCategoryRequest;
...
//                        subcategory_rV.setLayoutManager(new LinearLayoutManager(SubCategoryActivity.this));
                            ...
                            subcategory_rV.setLayoutManager(autolayoutManager);*/
                            LinearLayoutManager layoutManager = new GridLayoutManager(SubCategoryActivity.this, 2);
//                            subcategory_rV.setLayoutManager(layoutManager);
                        } else {
                            ll_Data_Found.setVisibility(View.GONE);
                            ll_NoData_Found.setVisibility(View.VISIBLE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            mintent = new Intent(SubCategoryActivity.this, SearchProductActivity.class);
            startActivity(mintent);
        }
