...
//    }
    ...
    public String toString() {
        return "ProductRequest{" +
                ...
                ", artNo='" + artNo + '\'' +
                ", artName='" + artName + '\'' +
                ", artShadeNo='" + artShadeNo + '\'' +
                ", artWidth='" + artWidth + '\'' +
                ", artSellingPriceAmt=" + artSellingPriceAmt +
//                ", artOfferPrice='" + artOfferPrice + '\'' +
                ...
                ", catName='" + catName + '\'' +
                ", scatName='" + scatName + '\'' +
                ", artSgstPer=" + artSgstPer +
                ", artCgstPer=" + artCgstPer +
                ", artIgstPer=" + artIgstPer +
                ", artQtyMtrs=" + artQtyMtrs +
                ", total_stock=" + total_stock +
                ", art_name_no='" + art_name_no + '\'' +
                '}';
    }
}
